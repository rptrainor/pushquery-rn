  ...
  return (
    <View>
      <View style={tosStyles.scrollContainer}>
        ...
        >
          <Text style={styles.header_text}> Pushquery Terms of Service:</Text>
          <Text style={styles.header2_text}>1. Be Kind</Text>
          <Text style={tosStyles.tosText}>
            We are a community that leads with love. We live this value by
            making sure our comments help, support, and encourage every person
            that we communicate with. Language that does not demonstrate
            kindness towards others will be removed, and the author of the
            comment will be held accountable for their violation of our values.
            There will be no tolerance for objectionable content or abusive
            users inside the Pushquery community.
          </Text>
          <Text style={styles.header2_text}>2. Be Helpful</Text>
          <Text style={tosStyles.tosText}>
            We believe that scholarly research should be open, accessible, and
            encourage participation. Research does not need to exist only
            steeped in dense discipline jargon or locked behind paywalls.
            Imagine that you are discussing your research with a researcher from
            a different field, or maybe you are lucky enough to be presenting to
            a classroom of school children -- how would you explain that new and
            interesting research question you are trying to solve? This is the
            language we want to encourage within the Pushquery community,
            language that both informs your peers and invites newcomers to your
          ...
          <Text style={tosStyles.tosText}>
            ...
            you would like to get some early feedback on your own Talk, share
            your Talk’s link and invite your lab-mates / colleagues to help you
            get the conversation going.
          </Text>
          <Text style={styles.header2_text}>End User License Agreement:</Text>
          ...
          <Text style={tosStyles.tosText}>
            ...
            replace or supplement the original Licensed Application, unless such
            upgrade is accompanied by a Custom EULA. Except as provided in the
            Usage Rules, you may not distribute or make the Licensed Application
            available over a network where it could be used by multiple devices
            at the same time. You may not transfer, redistribute or sublicense
            the Licensed Application and, if you sell your Apple Device to a
            third party, you must remove the Licensed Application from the Apple
            Device before doing so. You may not copy (except as permitted by
            ...
            works of the Licensed Application, any updates, or any part thereof
          ...
          <Text style={tosStyles.tosText}>
            ...
            any applicable laws. Licensor reserves the right to change, suspend,
          ...
          <Text style={tosStyles.tosText}>
            ...
            of the jurisdiction in which the Licensed Application was obtained.
            In particular, but without limitation, the Licensed Application may
            not be exported or re-exported (a) into any U.S.-embargoed countries
            ...
            or on any such list. You also agree that you will not use these
            products for any purposes prohibited by United States law,
            including, without limitation, the development, design, manufacture,
            or production of nuclear, missile, or chemical or biological
            weapons.
          </Text>
          ...
          <Text style={tosStyles.tosText}>
            ...
            its conflicts of law provisions. You and Apple agree to submit to
            the personal and exclusive jurisdiction of the courts located within
            the county of Santa Clara, California, to resolve any dispute or
            claim arising from this Agreement. If (a) you are not a U.S.
            citizen; (b) you do not reside in the U.S.; (c) you are not
          ...
          <Text style={tosStyles.tosText}>
            ...
            courts of your usual place of residence. Specifically excluded from
